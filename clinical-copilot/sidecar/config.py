...
class Settings(BaseSettings):
    ...
    # Filesystem path to the RSA private key (PEM, PKCS#8) used to sign
    # the SMART Backend Services jwt-bearer assertion (RFC 7523).
    # Generated by clinical-copilot/scripts/setup-openemr-client.sh and
    # stored at clinical-copilot/.keys/openemr-jwt-bearer.pem (gitignored).
    openemr_private_key_path: str | None = None
    # Legacy: confidential-client shared secret. NO LONGER USED for
    # client_credentials — OpenEMR's CustomClientCredentialsGrant
    # only accepts jwt-bearer assertions and rejects Basic auth. Kept
    # in the schema so older .env files keep loading without error.
